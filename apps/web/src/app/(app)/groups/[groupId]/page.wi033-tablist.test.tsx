// spec-WI-033 — runtime DOM inspection: does the group page render more than
// one role="tablist" for Expenses/Balances/Totals? Per the spec, deletion of
// the sole tablist is forbidden without a confirmed duplicate — this test is
// the runtime evidence backing the "no duplicate found" finding recorded in
// build-WI-batch2-web.md.
...
describe('GroupPage — tablist duplication runtime check (spec-WI-033)', () => {
  beforeEach(() => {
  ...
  it('renders exactly one role="tablist" for Expenses/Balances/Totals', () => {
    render(<GroupPage />);
    expect(screen.getAllByRole('tablist')).toHaveLength(1);
  });

  it('renders exactly one Expenses tab, one Balances tab, one Totals tab', () => {
    render(<GroupPage />);
